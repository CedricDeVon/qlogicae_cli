	...
	std::string Utilities::get_application_about_details()
	{
		try
		{
			return
				...
				"Id: \t\t\t" + QLogicaeCore::QLOGICAE_APPLICATION_UTILITIES.CONFIGURATIONS_APPLICATION_ID + "\n" +
				...
				"Authors: \t\t" + QLogicaeCore::QLOGICAE_APPLICATION_UTILITIES.CONFIGURATIONS_APPLICATION_AUTHORS + "\n" +
